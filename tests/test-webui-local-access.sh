...
grep -Fq "line 'Web interface:'" "${motd}"
grep -Fq "line 'Open in browser:'" "${motd}"
grep -Fq "line 'Direct address:'" "${motd}"
grep -Fq "line 'Enable with:'" "${motd}"
grep -Fq "line 'Check status:'" "${motd}"
