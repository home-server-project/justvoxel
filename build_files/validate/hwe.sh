...
rpm -q     nut nut-client btrfs-progs smartmontools smartmontools-selinux nvme-cli     lm_sensors ethtool usbutils pciutils dmidecode fwupd fwupd-efi     NetworkManager-wifi microcode_ctl amd-ucode-firmware atheros-firmware     brcmfmac-firmware iwlwifi-dvm-firmware iwlwifi-mvm-firmware realtek-firmware     mt7xxx-firmware hdparm powertop >/dev/null
